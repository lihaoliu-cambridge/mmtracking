...
def color_val_matplotlib(color):
    ...
    """
    # color = mmcv.color_val(color)
    color = [single_color / 255 for single_color in color]
    return tuple(color)


def imshow_det_bboxes_with_different_colors(img,
                      bboxes,
                      labels,
                      segms=None,
                      class_names=None,
    ...
    bbox_color_code_list = [[106, 0, 228], [174, 57, 255], [255, 109, 65], [0, 0, 192], [0, 0, 142],
         [255, 77, 255], [120, 166, 157], [209, 0, 151], [0, 226, 252], [179, 0, 194]]
    bbox_color_list = [color_val_matplotlib(bbox_color) for bbox_color in bbox_color_code_list]
    text_color_list = bbox_color_list 
    # text_color_list  = [color_val_matplotlib(bbox_color) for bbox_color in bbox_color_code_list]
    ...
    for i, (bbox, label) in enumerate(zip(bboxes, labels)):
        ...
        color.append(bbox_color_list[label])
